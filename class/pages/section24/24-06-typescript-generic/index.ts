...
const result = getGeneric<string, string, number>("철수", "", 1);
...
const result = getGeneric2<string, string, number>("철수", "", 1);
...
const result = getGeneric3<string, string, number>("철수", "", 1);
...
const result = getGeneric4<string, string, number>("철수", "", 1);
